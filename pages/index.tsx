...
export default function Home() {
	...
	<div>
		...
		<div className={`${isOpen ? 'absolute top-0 left-0 transition-transform duration-[0.3s] ease-[ease-out] bg-[rgba(33, 37, 41, 0.5)]' :
									'hidden'}`}>
			<div className={`${isOpen ? 'absolute top-0 left-0 bg-white h-screen w-[277px]' : 'hidden'}`}>
				{/* Hotel logo */}
		...
		<div 
			className={`${isOpen ? 'w-full bg-[rgba(33,37,41,0.5)] brightness-[50%] translate-x-[276px] transition-transform duration-[0.3s] ease-[ease-out]' :
			'absolute top-0 left-0 bg-white w-full'}`}>
